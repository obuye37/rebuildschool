...
const HowItWorks = () => {
  ...
  return (
    <div className='md:flex  items-center gap-4'>
      <div data-aos="fade-right" className='md:w-1/2 w-full overflow-hidden'>
        <img src="/image/image-4.jpg" alt="How it works" className="mx-auto object-cover w-full md:h-full h-[15rem]" /> 
      </div>
      <div data-aos="fade-left" className='flex-col h-full md:w-1/2 w-full justify-center items-center overflow-hidden p-10'>
